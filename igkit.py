     ...
     def report_profile_attack(username, nume):
          ...
          while c_while != nume:
               ...
               try:
                    ...
                    print_error("(FacebookRequestsError)")
               return
               print()


               if (res.status_code != 200):
                    print_error("(STATUS CODE:", res.status_code, ")")
               return
               print()
               ...
               try:
                    ...
                    print_error("(CookieParsingError)")
                    return
                    print()
               ...
               try:
                    ...
                    print_error("(InstagramRequestsError)")
                    return
                    print()
               ...
               if ("datr" not in res.cookies.get_dict()):
                    print_error("(CookieErrorDatr)")
                    return
                    print()
          
               if ('["LSD",[],{"token":"' not in res.text):
                    print_error("(CookieErrorLSD)")
                    return
                    print()
